    ...
    return(
        ...
        <div className="row container-fluid pt-4 ">
            ...
            <div className="col-md-8 bg-light text-center rounded pt-5 pb-5">
             <h2 className="text-primary">SignUp 2</h2>
             <div className="d-flex justify-content-center py-3">
                <label className="mx-3 fs-5" htmlFor="">Username :</label>
                <input className="mx-3 border-1 " type="text" name="" id="" />
             </div>
             <div className="d-flex justify-content-center py-3">
        ...
        <button className="btn btn-primary my-3" onClick={handleSignup}>Submit</button>
            </div>
            <div className="col-md-2"></div>
        </div>
        </>
